...
namespace DBoW2
{
  ...
  public:
    ...
    /**
     * Mr.Chen changed: 新增加Loads the vocabulary from a binary *file
     * @param filename
     */
    ...
    /**
     * Mr.Chen changed: 新增加Save the vocabulary into a binary *file
     * @param filename
     */
  ...
  // --------------------------------------------------------------------------
  // Mr.Chen changed: 2023.4.24 新增加保存为二进制文件
  template <class TDescriptor, class F>
