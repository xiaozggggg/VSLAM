...
void Viewer::Run()
{
    ...
    while(1)
    {
        ...
        //             {
        //                 cout << "area.RecArea.x: " << area.RecArea.x << endl;
        //                 cout << "area.RecArea.y: " << area.RecArea.y << endl;
        //                 cout << "area.RecArea.w: " << area.RecArea.width << endl;
        //                 cout << "area.RecArea.h: " << area.RecArea.height << endl;
        //                 cv::rectangle(toShow, area.RecArea, cv::Scalar(0, 0, 255), 1);
        //                 cv::putText(toShow,
        //                             vit->first,
        //                             cv::Point(area.RecArea.x, area.RecArea.y),
        //                             cv::FONT_HERSHEY_SIMPLEX, 1, cv::Scalar(0, 0, 0), 2);

        //                 //
                       
        //                 // cout << "vit->second.size(): " << vit->second.size() << endl;
        //                 // cout << "mvDynamicDepth.size: " << mvDynamicDepth.size() << endl;
        //                 // std::string str1 = "depth: ";
        //                 // float depth = area.depth;
        //                 // cout << "viewer_depth:" << depth << endl;  
        //                 // std::ostringstream ostr;
        //                 // ostr << str1 << depth; 
        //                 // cv::putText(toShow,
        //                 //             ostr.str(),
        //                 //             cv::Point(area.RecArea.x+area.RecArea.width/2, area.RecArea.y+area.RecArea.height/2),
        //                 //             cv::FONT_HERSHEY_SIMPLEX, 1, cv::Scalar(0, 0, 0), 2);
