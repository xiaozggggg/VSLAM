...
public:
    ...
    //发布Yolo框信息与使能
    string Yolomsg_enable;
    vector<string> Yolomsg;
...
public:
    ...
    // ---------------------------------------------------
    // Mr.Chen
    // localization mode flag
    std::atomic<bool> mbLocalization;
    // system control flag
    std::atomic<bool> mbSystemCtlFlag;
    // system init successful flag
    std::atomic<bool> mbSystemInitFlag;
    // Changed the root of this function from private to public
