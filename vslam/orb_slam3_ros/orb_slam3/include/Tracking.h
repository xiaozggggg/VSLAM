...
public:
    ...
    void SetDetector(YOLOv5_seg* pDetector);
    // void SetDetector();
    // void StereoDepth(int max_disparity, cv::Size image_size, CameraParam cam);
    // void getDisparity(cv::Mat imgL, cv::Mat imgR, cv::Mat &dispL, cv::Mat &dispR);
    // void getDepthImage(cv::Mat disparity, cv::Mat &depth);
